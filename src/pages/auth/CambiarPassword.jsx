...
const CambiarPassword = () => {
  ...
  return (
    <>       
        <h2 className="font-bold text-3xl text-center text-cyan-900 mt-10">Cambiar <span className="text-cyan-500 font-bold">Password</span> </h2>
                ...
                <form id="form1" onSubmit={handleSubmit}>
                    ...
                    <input 
                        type="submit"
                            ...
                            className="bg-cyan-600 mb-5 hover:bg-cyan-800 transition cursor-pointer py-3 rounded-lg w-full text-white font-bold mt-5 ">
                    </input>
