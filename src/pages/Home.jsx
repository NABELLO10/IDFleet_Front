...
const Home = ({camiones, setCamiones, notActiva, notTemp, ventana, empresaSistema, id_transportista, tiposNotificaciones, verFormulario}) => {
  ...
  return (
    <>   
{/*       {auth.nom_perfil == "Conductor" && <div>
      <TableroConductor empresaSistema = {empresaSistema} patente={patente} id_transportista = {id_transportista}  /></div>} */}
      
     {auth.nom_perfil != "Conductor" && (
